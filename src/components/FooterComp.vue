<template>
  <div>
    ...
    <div class="copyright d-flex align-items-center px-5 text-muted">
      <div>© Copyright 2012 - 2022 | Avada Theme by ThemeFusion | All Rights Reserved | Powered by WordPress</div>
    </div>
  </div>
</template>
